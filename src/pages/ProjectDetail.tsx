      ...
      <section className="ss-section bg-[var(--ss-navy)] text-white">
        <div className="ss-wrap grid gap-12 lg:grid-cols-[.62fr_1.38fr]">
          ...
          <ScrollReveal className="h-80 bg-[var(--ss-surface)] p-3">
            <ResponsiveContainer width="100%" height="100%"><BarChart data={finance}><CartesianGrid vertical={false} stroke="#e1ddd4" /><XAxis dataKey="label" tick={{ fontSize: 10, fill: '#72757b' }} tickLine={false} axisLine={false} /><YAxis tick={{ fontSize: 10, fill: '#72757b' }} tickLine={false} axisLine={false} /><Tooltip contentStyle={chartTooltip} /><Bar dataKey="revenue" fill="#17243b" name={t('projects.revenue')} /><Bar dataKey="expenses" fill="#a6a8ab" name={t('projectDetail.expenses')} /><Bar dataKey="fundraise" fill="#8b2635" name={t('projectDetail.fundraise')} /></BarChart></ResponsiveContainer>
          </ScrollReveal>
        </div>
      </section>
